...
import HidingSources from '@components/docs/HidingSources.astro';
import RequireChocolateyGuiLicensedExtensionNote from '@components/docs/RequireChocolateyGuiLicensedExtensionNote.astro';
import RestartRequiredWarning from '@components/docs/RestartRequiredWarning.astro';
