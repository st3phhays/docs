...
import IntuneDownloadArchitect from '@components/docs/IntuneDownloadArchitect.astro';
import IntuneDownloadBusiness from '@components/docs/IntuneDownloadBusiness.astro';
import IntuneNote from '@components/docs/IntuneNote.astro';
