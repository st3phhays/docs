 ...
 * ChocolateyPackageVersion - The version of the package.
   ...
   * Starting with Chocolatey CLI version 2.1.0 this is equivalent to the <Xref title="normalized version" value="upgrading-to-chocolatey-v2-v6" anchor="package-version-normalization" /> of the `<version />` field in the nuspec.
