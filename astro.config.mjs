...
export default defineConfig({
    ...
    redirects: {
        ...
        '/docs/helpers-get-environment-variable': '/en-us/create/functions/get-environmentvariable',
        '/docs/helpersgetenvironmentvariable': '/en-us/create/functions/get-environmentvariable',
        '/docs/helpers-get-environment-variable-names': '/en-us/create/functions/get-environmentvariablenames',
        '/docs/helpersgetenvironmentvariablenames': '/en-us/create/functions/get-environmentvariablenames',
        ...
        '/docs/helpers-install-chocolatey-path': '/en-us/create/functions/install-chocolateypath',
        '/docs/helpersinstallchocolateypath': '/en-us/create/functions/install-chocolateypath',
        ...
        '/docs/helpers-set-environment-variable': '/en-us/create/functions/set-environmentvariable',
        '/docs/helperssetenvironmentvariable': '/en-us/create/functions/set-environmentvariable',
        ...
        '/docs/helpers-test-process-admin-rights': '/en-us/create/functions/test-processadminrights',
        '/docs/helperstestprocessadminrights': '/en-us/create/functions/test-processadminrights',
        ...
        '/docs/helpers-update-session-environment': '/en-us/create/functions/update-sessionenvironment',
        '/docs/helpersupdatesessionenvironment': '/en-us/create/functions/update-sessionenvironment',
